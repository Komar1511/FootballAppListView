...
UPDATE Coaches 
SET ImageCoach = 
      (SELECT * FROM OPENROWSET(BULK N'C:\Coach\tuchel.jpg', SINGLE_BLOB) AS image)
WHERE id_coach = 1001
...
UPDATE Coaches 
SET ImageCoach = 
      (SELECT * FROM OPENROWSET(BULK N'C:\Coach\gisdol.jpg', SINGLE_BLOB) AS image)
WHERE id_coach = 1002
...
UPDATE Coaches 
SET ImageCoach = 
      (SELECT * FROM OPENROWSET(BULK N'C:\Coach\xavi.jpg', SINGLE_BLOB) AS image)
WHERE id_coach = 1003
...
UPDATE Coaches 
SET ImageCoach = 
      (SELECT * FROM OPENROWSET(BULK N'C:\Coach\guardiola.jpg', SINGLE_BLOB) AS image)
WHERE id_coach = 1004
...
UPDATE Coaches 
SET ImageCoach = 
      (SELECT * FROM OPENROWSET(BULK N'C:\Coach\anchelotti.jpg', SINGLE_BLOB) AS image)
WHERE id_coach = 1005
...
UPDATE Coaches 
SET ImageCoach = 
      (SELECT * FROM OPENROWSET(BULK N'C:\Coach\nagelsmann.jpg', SINGLE_BLOB) AS image)
WHERE id_coach = 1007
...
UPDATE Coaches 
SET ImageCoach = 
      (SELECT * FROM OPENROWSET(BULK N'C:\Coach\pochettino.jpg', SINGLE_BLOB) AS image)
WHERE id_coach = 1008
...
UPDATE Location 
SET ImageStadium = 
      (SELECT * FROM OPENROWSET(BULK N'C:\Stadium\Stamford.jpg', SINGLE_BLOB) AS image)
WHERE id_stadium = 10
...
UPDATE Location 
SET ImageStadium = 
      (SELECT * FROM OPENROWSET(BULK N'C:\Stadium\RZD.jpg', SINGLE_BLOB) AS image)
WHERE id_stadium = 20
...
UPDATE Location 
SET ImageStadium = 
      (SELECT * FROM OPENROWSET(BULK N'C:\Stadium\Camp.jpg', SINGLE_BLOB) AS image)
WHERE id_stadium = 30
...
UPDATE Location 
SET ImageStadium = 
      (SELECT * FROM OPENROWSET(BULK N'C:\Stadium\Etihad.jpg', SINGLE_BLOB) AS image)
WHERE id_stadium = 40
...
UPDATE Location 
SET ImageStadium = 
      (SELECT * FROM OPENROWSET(BULK N'C:\Stadium\Santiago.jpg', SINGLE_BLOB) AS image)
WHERE id_stadium = 50
...
UPDATE Location 
SET ImageStadium = 
      (SELECT * FROM OPENROWSET(BULK N'C:\Stadium\Gazprom.jpg', SINGLE_BLOB) AS image)
WHERE id_stadium = 60
...
UPDATE Location 
SET ImageStadium = 
      (SELECT * FROM OPENROWSET(BULK N'C:\Stadium\Allianz.jpg', SINGLE_BLOB) AS image)
WHERE id_stadium = 70
...
UPDATE Location 
SET ImageStadium = 
      (SELECT * FROM OPENROWSET(BULK N'C:\Stadium\Parc.jpg', SINGLE_BLOB) AS image)
WHERE id_stadium = 80
...
UPDATE Location 
SET ImageStadium = 
      (SELECT * FROM OPENROWSET(BULK N'C:\Stadium\Velodrom.jpg', SINGLE_BLOB) AS image)
WHERE id_stadium = 90
...
UPDATE Location 
SET ImageStadium = 
      (SELECT * FROM OPENROWSET(BULK N'C:\Stadium\Old.jpg', SINGLE_BLOB) AS image)
...
UPDATE Location 
SET ImageStadium = 
      (SELECT * FROM OPENROWSET(BULK N'C:\Stadium\Sansiro.jpg', SINGLE_BLOB) AS image)
...
UPDATE Location 
SET ImageStadium = 
      (SELECT * FROM OPENROWSET(BULK N'C:\Stadium\Otkritie.jpg', SINGLE_BLOB) AS image)
...
UPDATE Location 
SET ImageStadium = 
      (SELECT * FROM OPENROWSET(BULK N'C:\Stadium\Borussia.jpg', SINGLE_BLOB) AS image)
...
UPDATE Location 
SET ImageStadium = 
      (SELECT * FROM OPENROWSET(BULK N'C:\Stadium\Emirates.jpg', SINGLE_BLOB) AS image)
